          ...
          Expanded(
            child: ListView(
              children: [
                ...
                _buildCategorySection(
                  title: 'Fiscais',
                  courses: widget.controller.taxCourses,
                  icon: Icons.account_balance,
                  gradient: const [Color(0xFF4A90E2), Color(0xFF357ABD)],
                  count: widget.controller.taxCourses.length,
                ),
                SizedBox(height: responsivity.largeSpacing()),
                _buildCategorySection(
                  title: 'Contábeis',
                  courses: widget.controller.accountingCourses,
                  icon: Icons.calculate,
                  gradient: const [Color(0xFF7B68EE), Color(0xFF5A4FCF)],
                  count: widget.controller.accountingCourses.length,
                ),
                SizedBox(height: responsivity.largeSpacing()),
                _buildCategorySection(
                  title: 'Trabalhistas',
                  courses: widget.controller.laborCourses,
                  icon: Icons.work,
                  gradient: const [Color(0xFFFFD700), Color(0xFFFFA000)],
                  count: widget.controller.laborCourses.length,
                ),
              ],
            ),
          ),
